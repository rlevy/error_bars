...
In this example, N is `r nrow(filter(dat_oneitem,Type=="High attachment"))` for high attachment sentences and `r nrow(filter(dat_oneitem,Type=="Low attachment"))` for low attachment sentences
...
* For even the simplest data, your choices about error bars usually imply an implicit assumed generative model.
